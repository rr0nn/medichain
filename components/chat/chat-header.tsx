        ...
        >
          ...
          <ModelSelectorTrigger asChild>
            <Button
              ...
              size="sm"
              disabled={isLoading}
              className="h-auto w-[220px] justify-between rounded-xl border-[color:var(--glass-border)] bg-background/55 py-2 shadow-[inset_0_1px_0_var(--glass-highlight)] backdrop-blur-sm hover:bg-background/70"
            >
